...
export const RESOLUTION_PRESETS: Resolution[] = [
  ...
  { label: "MacBook Air 13\"/15\" (M2/M3, notched) — 2560×1664", width: 2560, height: 1664 },
  { label: "MacBook Pro 13\" (2022 or earlier) — 2560×1600", width: 2560, height: 1600 },
  { label: "MacBook Pro 14\"/16\" — 3024×1964", width: 3024, height: 1964 },
